<script>
  import HowItemsList from './HowItemsList.svelte'

  export let id
  export let title = 'ПОЧЕМУ БАРТЕР С МИКРО-БЛОГЕРАМИ ЭТО ВЫГОДНО'
  export let items = [
    {
...
<section {id} class="how">
  <div class="how__wrapper container">
    <h2 class="how__title">{title}</h2>
